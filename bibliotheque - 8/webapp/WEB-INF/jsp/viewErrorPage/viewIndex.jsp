...
<html>
  <head>
    ...
    <link rel="stylesheet" href="css/viewErrorPage/stylesheet.css" type="text/css"/>
  ...
  <body>
    <div id="index-template" class="index-template"><jsp:include page="/WEB-INF/jsp/viewErrorPage/layout/viewErrorPage.jsp" flush="true"/></div>
  </body>
</html>
