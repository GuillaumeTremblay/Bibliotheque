...
public interface IPretDAO extends IDAO {
    ...
    /**
     * Trouve les pret d'un membre. La liste est classée par ordre croissant sur <code>sortByPropertyName</code>. Si aucune réservation
    ...
    /**
     * Trouve les prêt d'un livre. La liste est classée par ordre croissant sur <code>sortByPropertyName</code>. Si aucune réservation
     * n'est trouvée, une {@link List} vide est retournée.
     *
     * @param connexion La connexion à utiliser
